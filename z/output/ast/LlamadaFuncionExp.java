...
public class LlamadaFuncionExp extends AbstractExpresion {

	public LlamadaFuncionExp(String nombreFuncion, List<Expresion> parametrosOpcionales) {
	...
	public LlamadaFuncionExp(Object nombreFuncion, Object parametrosOpcionales) {
		this.nombreFuncion = (nombreFuncion instanceof Token) ? ((Token)nombreFuncion).getText() : (String) nombreFuncion;
